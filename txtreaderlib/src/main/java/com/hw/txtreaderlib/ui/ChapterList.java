    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                holder.index = (TextView) view.findViewById(R.id.adapter_chatperlist_index);
                holder.title = (TextView) view.findViewById(R.id.adapter_chatperlist_title);
                holder.progress = (TextView) view.findViewById(R.id.adapter_chatperlist_progress);
                view.setTag(holder);
            } else {
